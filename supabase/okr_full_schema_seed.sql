...
CREATE TABLE IF NOT EXISTS okr_objectives (
  ...
  owner_department_id UUID REFERENCES okr_departments(id),
  resource_note TEXT,
  start_date DATE,
  end_date DATE,
...
ALTER TABLE okr_objectives ADD COLUMN IF NOT EXISTS owner_department_id UUID REFERENCES okr_departments(id);
ALTER TABLE okr_objectives ADD COLUMN IF NOT EXISTS resource_note TEXT;
